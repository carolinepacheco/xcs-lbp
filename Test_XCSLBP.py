...
from algorithms.LBP import *
from algorithms.CSLBP import *
from algorithms.XCSLBP import *




def show_result(imgXCSLBP, image):
...
# Call calculate_XCSLBPfunction
imgXCSLBP = LBP(image)
#imgXCSLBP = XCSLBP(image)
#imgXCSLBP = CSLBP(image)
# Call show_result function
show_result(imgXCSLBP, image)
